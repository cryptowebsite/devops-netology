...
1	Иванов Иван Иванович	USA	\N
2	Петров Петр Петрович	Canada	\N
3	Иоганн Себастьян Бах	Japan	\N
...
COPY public.orders (id, product_name, price) FROM stdin;
1	Шоколад	10
2	Принтер	3000
3	Книга	500
4	Монитор	7000
...
--
-- Name: idx_clients_country; Type: INDEX; Schema: public; Owner: postgres
--
